...
<body class="bg-white text-gray-900">
  ...
  <div class="bg-[#121212] text-white border-b border-gray-800 py-1 shadow-sm">
    <div class="max-w-7xl mx-auto px-6 flex items-center justify-between text-sm">
      ...
      <div class="flex items-center gap-8">
        ...
        <nav class="flex items-center gap-7 font-medium">
          <a href="#" class="nav-link flex items-center gap-1.5 hover:text-white">
          ...
          <a href="#" class="nav-link hover:text-white">Sell</a>
          <a href="#" class="nav-link flex items-center gap-1.5 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="#" class="nav-link hover:text-white">Help</a>
          <a href="#" class="nav-link text-amber-400 font-semibold hover:text-amber-300">VIP</a>
        </nav>
